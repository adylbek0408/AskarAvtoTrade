    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('damage_photos', models.ImageField(blank=True, null=True, upload_to='cars/damages/', verbose_name='Фото повреждений')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('object_id', models.PositiveIntegerField()),
                ('steering_wheel', models.CharField(choices=[('regular', 'Руль'), ('multi', 'Мультируль')], max_length=20, verbose_name='Тип руля')),
