    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(blank=True, null=True, verbose_name='Ссылка на машину')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('korea_car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='korea_cars', to='korea.korea', verbose_name='Корея:')),
            ],
            options={
